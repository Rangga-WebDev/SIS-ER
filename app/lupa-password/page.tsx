...
export const metadata = { title: "Lupa Password | JAFUNG SMART" };
...
export default function LupaPasswordPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f7fbff] px-6 py-10 text-slate-900">
      ...
      <section className="relative z-10 mx-auto flex min-h-[calc(100vh-80px)] max-w-7xl items-center justify-center">
        <ForgotPasswordForm />
      </section>
    </main>
  );
